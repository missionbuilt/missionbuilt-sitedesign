...
var RETURN_PAGES = /* @__PURE__ */ new Set([
  "/rack/mealstack",
  "/rack/ironstack",
  "/rack"
]);
...
async function onRequestPost({ request, env }) {
  ...
  const record = {
    ...
    at: existing && existing.at || (/* @__PURE__ */ new Date()).toISOString(),
    ...
    pages: [.../* @__PURE__ */ new Set([...existing && existing.pages || [], ...RETURN_PAGES.has(page) ? [page] : []])]
  };
...
async function safeEqual(a, b) {
  ...
  const mac = /* @__PURE__ */ __name(async (v) => {
...
// ../.wrangler/tmp/pages-HLZq5q/functionsRoutes-0.513969867379692.mjs
var routes = [
  {
    routePath: "/api/beta",
    mountPath: "/api",
