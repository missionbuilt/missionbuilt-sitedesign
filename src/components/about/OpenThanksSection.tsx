...
const OpenThanksSection = () => {
  return (
    <div className="mb-16">
      <Card className="bg-gradient-to-br from-slate/5 to-slate/10 hover:shadow-md transition-shadow duration-300 border border-slate/10">
        <CardContent className="p-8">
          <h3 className="text-2xl font-semibold mb-6 text-center">Open Thanks</h3>
