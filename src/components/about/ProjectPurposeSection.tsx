    ...
    <div className="mb-16">
      <Card className="bg-white dark:bg-white hover:shadow-md transition-shadow duration-300 border border-slate/10">
        <CardContent className="p-8">
          <h3 className="text-2xl font-semibold mb-6 text-center text-slate dark:text-slate">This project exists to:</h3>
          
          <ul className="space-y-6 text-slate dark:text-slate list-none">
          ...
          <p className="mt-8 text-slate dark:text-slate font-medium text-center border-t border-slate/10 pt-6">
