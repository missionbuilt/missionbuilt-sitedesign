...
<p>Rituals aren't constraints — they're commitments. But only if we let them evolve. The strongest systems, the longest-lasting teams, the most resilient lifters — all share this in common: they don't cling to routine for routine's sake. They adapt. With intention. With feedback. With mission in mind.</p>`
  ...
  },
  {
    ...
    description: "The power of laser-focused feedback that cuts through noise and creates real impact.",
    slug: "cues-not-critiques",
    status: "published" as const,
    date: "2024-12-13",
    readTime: "8 min read",
    excerpt: "The power of laser-focused feedback that cuts through noise and creates real impact.",
    content: `
      <div class="chapter-content">
        <section class="mb-8">
          <h2 class="text-2xl font-bold mb-4">Cues, Not Critiques</h2>
        ...
        <section class="mb-8">
          <h3 class="text-xl font-semibold mb-4">Point the Flashlight</h3>
          <div class="prose prose-lg max-w-none">
        ...
        <section class="mb-8">
          <h3 class="text-xl font-semibold mb-4">Two Words That Changed the Lift</h3>
          <div class="prose prose-lg max-w-none">
        ...
        <section class="mb-8">
          <h3 class="text-xl font-semibold mb-4">From Backlog to Breakthrough</h3>
          <div class="prose prose-lg max-w-none">
        ...
        <section class="mb-8">
          <h3 class="text-xl font-semibold mb-4">The Flashlight, Not the Floodlight</h3>
          <div class="prose prose-lg max-w-none">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-bold mb-4">Make Feedback a Ritual</h2>
          <div class="prose prose-lg max-w-none">
            <p>Feedback isn't something you give once a quarter. It's not a Slack comment or a surprise at review time. It's a rhythm. A rep.</p>
        ...
        <section class="mb-8">
          <h3 class="text-xl font-semibold mb-4">Slack: Feedback as the Product</h3>
          <div class="prose prose-lg max-w-none">
        ...
        <section class="mb-8">
          <h3 class="text-xl font-semibold mb-4">Elastic: Customer Zero and Design Partner Rituals</h3>
          <div class="prose prose-lg max-w-none">
        ...
        <section class="mb-8">
          <h3 class="text-xl font-semibold mb-4">Relationship-Level Listening</h3>
          <div class="prose prose-lg max-w-none">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-bold mb-4">Listening Is a Lift</h2>
          <div class="prose prose-lg max-w-none">
            <p>You've built the ritual. You're getting the feedback. Now comes the hard part: listening.</p>
        ...
        <section class="mb-8">
          <h3 class="text-xl font-semibold mb-4">When the Data Lies — or We Lie to Ourselves</h3>
          <div class="prose prose-lg max-w-none">
            <p>Take Fitbit.</p>
            ...
            <blockquote class="border-l-4 border-blue-500 pl-4 italic text-gray-700 my-4">
              When you only listen to what makes you feel good, you stop seeing what's real.<br/>
        ...
        <section class="mb-8">
          <h3 class="text-xl font-semibold mb-4">Real Strength Isn't in the Signal — It's in the Interpretation</h3>
          <div class="prose prose-lg max-w-none">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-bold mb-4">Strong Feedback, Strong Foundations</h2>
          <div class="prose prose-lg max-w-none">
            <p>We should strive for feedback that's constructive — not combative.</p>
            ...
            <blockquote class="border-l-4 border-blue-500 pl-4 italic text-gray-700 my-4">
              When feedback is anchored in empathy and structured around the mission, it becomes a lift — not a weight.<br/>
        ...
        <section class="mb-8">
          <h3 class="text-xl font-semibold mb-4">Strong Feedback Is Often Micro</h3>
          <div class="prose prose-lg max-w-none">
        ...
        <section class="mb-8">
          <h3 class="text-xl font-semibold mb-4">Share Early, Improve Always</h3>
          <div class="prose prose-lg max-w-none">
            ...
            <blockquote class="border-l-4 border-blue-500 pl-4 italic text-gray-700 my-4">
              That's the Medici principle: seek feedback while ideas are still flexible — not fixed.<br/>
            ...
            <blockquote class="border-l-4 border-blue-500 pl-4 italic text-gray-700 my-4">
              The earlier you share, the better the outcome.<br/>
        ...
        <section class="mb-8">
          <h3 class="text-xl font-semibold mb-4">Strong Feedback Builds Strong People</h3>
          <div class="prose prose-lg max-w-none">
            ...
            <blockquote class="border-l-4 border-blue-500 pl-4 italic text-gray-700 my-4">
              Feedback that fuels — not frustrates.<br/>
