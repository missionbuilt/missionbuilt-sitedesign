...
- **Deleting a lift that came from a loaded workout stays deleted; it no longer comes straight back under Up next.** Up next rows also swipe to skip a lift for today.
