  ...
  return <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-grow container mx-auto px-4 py-8 md:py-12">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-10">
            <ChaptersHeader title="Training Logs" subtitle="Lift Heavy. Lead Strong. One Rep, One Release at a Time." />
          </div>
          ...
          <div className="mb-8 text-center">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-display font-bold text-army dark:text-army">
              Mission Built<span className="mx-2">Lessons from the Barbell and the Boardroom</span><span className="font-normal text-muted-foreground">Lessons from the Barbell and the Backlog</span>
            </h2>
          </div>
          
          {/* View toggle for grid/table */}
          <div className="mb-6 flex justify-end">
            <Tabs defaultValue="grid" value={viewMode} onValueChange={value => setViewMode(value as "grid" | "table")} className="w-[200px]">
          ...
          <div>
            {viewMode === "grid" ? <ChapterGrid chapters={chapters} /> : <div className="mt-0">
