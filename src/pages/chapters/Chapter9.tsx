...
const Chapter9 = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>{metadata?.title || 'Ship It Like You Show Up'} - MissionBuilt</title>
        <meta name="description" content={metadata?.description || 'Great teams ship with the same integrity they train with. This chapter draws a line between effort in the gym and excellence in execution — showing how preparation, not perfection, defines professional momentum.'} />
      </Helmet>
      ...
      <div className="relative h-96 overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          ...
          <h1 className="font-display font-bold text-4xl md:text-5xl lg:text-6xl text-white mb-6 leading-tight drop-shadow-lg">
            {metadata?.title || 'Ship It Like You Show Up'}
          </h1>
          <div className="flex items-center gap-6 text-white/95 text-sm font-medium">
            <div className="flex items-center">
              <Calendar className="w-4 h-4 mr-2" />
              Published {metadata?.publishedDate ? formatPublishDate(metadata.publishedDate) : formatPublishDate('2025-01-15')}
            </div>
            <div className="flex items-center">
