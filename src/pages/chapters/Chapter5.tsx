...
const Chapter5 = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>{metadata?.title || 'Field Note 5'} - MissionBuilt</title>
      ...
      <div className="relative h-96 overflow-hidden">
        <img 
          src="/lovable-uploads/5dfc9c65-14fa-4b3a-9bca-fa90b8907d40.png"
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <header className="mb-16">
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6 font-display leading-tight">
              {metadata?.title || 'Field Note 5: Chapter Title'}
            </h1>
