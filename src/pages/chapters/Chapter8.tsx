...
const Chapter8 = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>{metadata?.title || 'Field Note 8'} - MissionBuilt</title>
      ...
      <div className="relative h-96 overflow-hidden">
        <img 
          src="/lovable-uploads/71c86e54-ebdf-4d51-8c3d-daaac4d85983.png"
          alt="Field Note 8 Hero"
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          ...
          <h1 className="font-display font-bold text-4xl md:text-5xl lg:text-6xl text-white mb-6 leading-tight drop-shadow-lg">
            {metadata?.title || 'Chapter 8 Title'}
          </h1>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <header className="mb-16">
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6 font-display leading-tight">
              {metadata?.title || 'Field Note 8: Chapter Title'}
            </h1>
